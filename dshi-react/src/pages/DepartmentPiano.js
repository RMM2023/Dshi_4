        ...
        <div>
            ...
            <div class="docs">
                <div class="card-container-docs">
                    <div id="piano_annotation" class="card-doc" onclick="window.location.href='programs/piano/piano_annotation.pdf'">
                        <img src="Icons\annotation_icon.png"/>
                        <a>Аннотация "Фортериано"</a>
                    </div>
                    <div id="piano_ansamble_annotation" class="card-doc" onclick="window.location.href='programs/piano/piano_ansamble_annotation.pdf'">
                        <img src="Icons\annotation_icon.png"/>
                        <a>Аннотация "Фортепиано. Ансамбль"</a>
                    </div>
                    <div id="piano_DPP" class="card-doc" onclick="window.location.href='programs/piano/piano_DPP.pdf'">
                        <img src="Icons\programm_icon.png"/>
                        <a>ДПП "Фортериано"</a>
                    </div>
                    <div id="piano_ansamble_DPP" class="card-doc" onclick="window.location.href='programs/piano/piano_ansamble_DPP.pdf'">
                        <img src="Icons\programm_icon.png"/>
