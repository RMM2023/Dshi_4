        ...
        <div>
            ...
            <div className="docs">
                <div className="card-container-docs">
                    <div id="piano_annotation" className="card-doc" onClick="window.location.href='programs/piano/piano_annotation.pdf'">
                        <img src={iconAnnotation}/>
                        <a>Аннотация "Фортериано"</a>
                    </div>
                    <div id="piano_ansamble_annotation" className="card-doc" onClick="window.location.href='programs/piano/piano_ansamble_annotation.pdf'">
                        <img src={iconAnnotation}/>
                        <a>Аннотация "Фортепиано. Ансамбль"</a>
                    </div>
                    <div id="piano_DPP" className="card-doc" onClick="window.location.href='programs/piano/piano_DPP.pdf'">
                        <img src={iconProgramm}/>
                        <a>ДПП "Фортериано"</a>
                    </div>
                    <div id="piano_ansamble_DPP" className="card-doc" onClick="window.location.href='programs/piano/piano_ansamble_DPP.pdf'">
                        <img src={iconProgramm}/>
                        <a>ДПП "Фортепиано. Ансамбль"</a>
                    </div>
                </div>
            </div>
...
export default DepartmentPiano;