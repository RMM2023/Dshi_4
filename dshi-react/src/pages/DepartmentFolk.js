        ...
        <div>
                ...
                <div class="docs">
                    <div class="card-container-docs">
                        <div id="bayan_annotation" class="card-doc" onclick="window.location.href='programs/folk/bayan_annotation.pdf'">
                            <img src={iconAnnotation}/>
                            <a>Аннотация "Баян"</a>
                        </div>
                        <div id="accordion_annotation" class="card-doc" onclick="window.location.href='programs/folk/accordion_annotation.pdf'">
                            <img src={iconAnnotation}/>
                            <a>Аннотация "Аккордион"</a>
                        </div>
                        <div id="ansamble_bayan_accordion_annotation" class="card-doc" onclick="window.location.href='programs/folk/ansamble_bayan_accordion_annotation.pdf'">
                            <img src={iconAnnotation}/>
                            <a>Аннотация "Ансамбль (баян, аккордион)"</a>
                        </div>
                        <div id="bayan_DPP.pdf" class="card-doc" onclick="window.location.href='programs/folk/bayan_DPP.pdf'">
                            <img src={iconProgramm}/>
                            <a>ДПП "Баян"</a>
                        </div>
                        <div id="accordion_DPP" class="card-doc" onclick="window.location.href='programs/folk/accordion_DPP.pdf'">
                            <img src={iconProgramm}/>
                            <a>ДПП "Аккордион"</a>
                        </div>
                        <div id="ansamble_bayan_accordion_DPP" class="card-doc" onclick="window.location.href='programs/folk/ansamble_bayan_accordion_DPP.pdf'">
                            <img src={iconProgramm}/>
