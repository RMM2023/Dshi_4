        ...
        <div>
            ...
            <div className="docs">
                <div className="card-container-docs">
                    <div id="vocal_annotation" className="card-doc" onClick="window.location.href='programs/vocal/vocal_annotation.pdf'">
                        <img src={iconAnnotation}/>
                        <a>Аннотация "Вокал"</a>
                    </div>
                    <div id="vocal_DOO" className="card-doc" onClick="window.location.href='programs/vocal/vocal_DOO.pdf'">
...
export default DepartmentVocal;